  ...
  <div>
    <div class="login_view">
      <el-form :model="loginForm" class="login_form">
        <div class="title_view">景区管理系统登录</div>
...
.login_view {
  ...
  background: url(http://localhost:8080/tourismvue/file/9712345d93bd40738be9e31e19e7c651.png);
  display: flex;
  min-height: 100vh;
  ...
  .btn_view {
    ...
    .register {
      ...
      outline: none;
      color: #333;
      background: rgba(24, 140, 145, 0.3);
      font-weight: bold;
      width: 200px;
      font-size: 16px;
      height: 50px;
